...
import { oauthAppleEnabled, oauthGoogleEnabled, showOAuthSection } from '@/lib/oauth-flags'
...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (err === 'auth_failed') {
      toast.error('Sign-in didn’t complete. Try the email link, or check Google/Apple is enabled in Supabase.')
    }
  }, [searchParams])
