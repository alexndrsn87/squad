  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-text-secondary text-sm">Sign in to your SQUAD account</p>
      </div>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center">
          <span className="px-3 bg-bg-card text-text-muted text-xs">or sign in with email</span>
        </div>
      </div>
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex">
      {/* Left panel */}
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-bg-card border-r border-bg-border p-12">
        <div className="font-display text-4xl tracking-widest text-brand">SQUAD</div>

        <div>
          <blockquote className="text-2xl font-display tracking-wide leading-snug mb-6 text-text-primary">
            &ldquo;Finally sorted the group chat nightmare. Everyone pays before the game, teams are always
            balanced.&rdquo;
          </blockquote>
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium">Marcus K.</div>
              <div className="text-xs text-text-muted">Runs 3 five-a-side teams in London</div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          {/* Mobile logo */}
          <div className="lg:hidden font-display text-3xl tracking-widest text-brand mb-8">SQUAD</div>
          <Suspense>
            <LoginForm />
          </Suspense>
        </div>
